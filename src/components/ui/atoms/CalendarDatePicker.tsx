  ...
  "flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium text-foreground ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border-200 bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
                  ...
                  <div className="border-foreground/10 flex flex-col gap-1 border-r pr-4 text-left">
                    {dateRanges.map(({ label, start, end }) => (
                      <Button
                        ...
                        size="sm"
                        className={cn(
                          "hover:bg-primary/90 justify-start hover:text-background",
                          selectedRange === label &&
                            "hover:bg-primary/90 bg-primary text-background hover:text-background",
                        )}
                        onClick={() => {
